...
/* package social-network-simulation-0.1.0.0 */
#ifndef VERSION_social_network_simulation
#define VERSION_social_network_simulation "0.1.0.0"
#endif /* VERSION_social_network_simulation */
#ifndef MIN_VERSION_social_network_simulation
#define MIN_VERSION_social_network_simulation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_social_network_simulation */
...
#define CURRENT_PACKAGE_KEY "social-network-simulation-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "social-network-simulation-0.1.0.0-inplace"
